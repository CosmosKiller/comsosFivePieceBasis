 ...
 * @brief Matter commissioning, fabric, and identify/attribute callbacks for the dual-mode button.
 * @version 0.1
 * @date 2025-09-15
 *
                                  ...
                                  uint32_t attribute_id, esp_matter_attr_val_t *val, void *priv_data)
{
    ...
    if (type == PRE_UPDATE) {
        /* Driver update */
        iot_button_task_handle_t iot_button_task_handle = (iot_button_task_handle_t)priv_data;
        err = iot_button_attribute_update(iot_button_task_handle, endpoint_id, cluster_id, attribute_id, val);
    }
