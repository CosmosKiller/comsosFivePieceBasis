 ...
 * @brief Matter callbacks for the bedside lamp.
 */
                                  ...
                                  uint32_t attribute_id, esp_matter_attr_val_t *val, void *priv_data)
{
    ...
    if (type == PRE_UPDATE) {
        lamp_task_handle_t lamp_handle = (lamp_task_handle_t)priv_data;
        err = lamp_task_attribute_update(lamp_handle, endpoint_id, cluster_id, attribute_id, val);
    }
