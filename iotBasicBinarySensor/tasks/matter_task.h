/**
 * @file matter_task.h
 * @brief Matter stack callbacks (events, identify, attribute updates) for the binary sensor.
 */
...
#define FACTORY_RESET_BUTTON_GPIO GPIO_NUM_9 /*!< Factory-reset button (legacy define) */
